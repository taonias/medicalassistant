...
- [ ] Documentation or operational contract
...
Owning bounded context/capability:

Relevant refactor row(s):

Known-risk ID(s):

Validation performed:

Intentional behavior changes and migration/compatibility plan (leave blank for structural refactors):
