...
public sealed class RabbitMqTranscriberProcessingPublisher : ITranscriberProcessingPublisher, IAsyncDisposable
{
    ...
    private readonly ILogger<RabbitMqTranscriberProcessingPublisher> _logger;
    private readonly SemaphoreSlim _connectionLock = new(1, 1);
    private readonly SemaphoreSlim _queueLock = new(1, 1);
    private IConnection? _connection;

    public RabbitMqTranscriberProcessingPublisher(
        IOptions<RabbitMqSettings> settings,
        ILogger<RabbitMqTranscriberProcessingPublisher> logger)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            _logger.LogInformation(
                ...
                message.EventType,
                _settings.TranscriberProcessingQueue,
                message.ConsultationId);
        }
        finally
        {
    ...
    private async Task EnsureQueueAsync(IChannel channel, CancellationToken cancellationToken)
    {
        await channel.QueueDeclareAsync(
            queue: _settings.TranscriberProcessingQueue,
            durable: true,
            exclusive: false,
            autoDelete: false,
            arguments: null,
        ...
        CancellationToken cancellationToken)
    {
        ...
        await channel.BasicPublishAsync(
            ...
            routingKey: _settings.TranscriberProcessingQueue,
            mandatory: false,
